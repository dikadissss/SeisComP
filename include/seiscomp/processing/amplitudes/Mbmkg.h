...
#ifndef SEISCOMP_PROCESSING_AMPLITUDEPROCESSOR_Mbmkg_H
#define SEISCOMP_PROCESSING_AMPLITUDEPROCESSOR_Mbmkg_H
...
//! the proxy (see below).
class SC_SYSTEM_CLIENT_API AmplitudeProcessor_Mbmkg : public AbstractAmplitudeProcessor_ML {
	public:
		AmplitudeProcessor_Mbmkg();

	friend class AmplitudeProcessor_Mbmkg2h;
};


class SC_SYSTEM_CLIENT_API AmplitudeProcessor_Mbmkg2h : public AmplitudeProcessor {
	public:
		AmplitudeProcessor_Mbmkg2h();
	...
	private:
		...
		mutable AmplitudeProcessor_Mbmkg _ampE, _ampN;
